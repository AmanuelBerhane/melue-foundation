# -*- encoding: utf-8 -*-
# stub: actionpack 8.1.3.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v8.1.3.1/actionpack/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v8.1.3.1/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/rails/tree/v8.1.3.1/actionpack" } if s.respond_to? :metadata=
