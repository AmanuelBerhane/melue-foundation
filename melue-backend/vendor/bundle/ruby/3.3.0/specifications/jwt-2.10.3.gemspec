# -*- encoding: utf-8 -*-
# stub: jwt 2.10.3 ruby lib

Gem::Specification.new do |s|
  s.name = "jwt".freeze
  s.version = "2.10.3".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/jwt/ruby-jwt/issues", "changelog_uri" => "https://github.com/jwt/ruby-jwt/blob/v2.10.3/CHANGELOG.md", "rubygems_mfa_required" => "true" } if s.respond_to? :metadata=
