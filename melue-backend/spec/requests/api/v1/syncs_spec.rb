        ...
        mutations: [
          {
            type: "Student",
            operation: "insert",
            data: { id: SecureRandom.uuid, first_name: "John", last_name: "Doe", date_of_birth: "2015-01-01", program_type: "regular", therapy_group: "basic", guardian_name: "Guardian Name", guardian_phone: "555-0000" }
          }
        ]
      }
